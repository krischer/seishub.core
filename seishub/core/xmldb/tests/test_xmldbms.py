...
from seishub.core.exceptions import InvalidObjectError, InvalidParameterError, \
...
from seishub.core.xmldb.resource import XML_DECLARATION_LENGTH, XmlDocument, \
