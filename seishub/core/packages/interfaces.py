...
class IAdminPanel(Interface):
    ...
    def render(request):  # @NoSelf
        ...
        template defined above or a plain string which will be directly
        rendered without using the template.
        """
...
class IProcessorIndex(Interface):
    ...
    def eval(document):  # @NoSelf
        ...
        This method has to return a single value or a list of values of the
        same type as specified in the 'type' attribute.
